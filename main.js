/* This program/function will generate a random, non-existant video game quote that you might see in a loading screen! Uh... maybe?
 ...
 let quoteMaker = () => {
    ...
    fourthWordArray = ['The Vileman Derelict', 'Ohio', 'an LDS Church', 'Brazil', 'A New York Alleyway', 'a Warzone', 'the Void', 'the Torture Dimension', 'a Sky Fortress']
     ...
     quoteBodyArray = [`Did you know that ${pickAWord} along with ${pickAWord} can be used to craft ${pickAWord}? We didn't!`, `You can dismantle ${pickAWord} to get ${pickAWord} and ${pickAWord}! It's strange, but Works!`, `${pickAWord} is one of the most powerful items in the game! Couldn't tell you why though!`, `${pickAWord}, an extremely valuable item, can be traded for lots of money!`, `${pickAWord}, a basically useless item, is probably best thrown into the nearest trash bin!`, `According to the ancient texts, ${pickAWord} grants magical properties to ${pickAWord}`, `Did you know ingesting ${pickAWord} will transport you to ${fourthWord}? Makes no damn sense.`, `Wandering around in ${fourthWord} grants a higher chance to find ${pickAWord}.`];
